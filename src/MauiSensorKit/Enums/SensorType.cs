...
public static class SensorTypeExtensions
{
    ...
    public static string GetIconName(this SensorType sensor)
    {
        return sensor switch
        {
            SensorType.Accelerometer => "move.3d",
            SensorType.Gyroscope => "arrow.triangle.2.circlepath",
            SensorType.Magnetometer => "safari",
            SensorType.GravitySensor => "arrow.down.circle",
            SensorType.LinearAcceleration => "speedometer",
            SensorType.RotationVector => "rotate.3d",
            SensorType.StepCounter => "figure.walk",
            SensorType.StepDetector => "figure.walk.motion",
            SensorType.ProximitySensor => "hand.raised",
            SensorType.AmbientLight => "sun.max",
            SensorType.Barometer => "gauge.with.dots.needle.67percent",
            SensorType.Temperature => "thermometer",
            SensorType.Humidity => "drop",
            SensorType.Location => "location",
            SensorType.Microphone => "mic",
            SensorType.Nfc => "wave.3.right",
            SensorType.Uwb => "dot.radiowaves.left.and.right",
            SensorType.HallSensor => "lock.square",
            SensorType.Battery => "battery.100",
            SensorType.BatteryTemperature => "battery.100.bolt",
            SensorType.Camera => "camera",
            SensorType.DepthSensor => "view.3d",
            SensorType.IRSensor => "eye.slash",
            SensorType.FingerprintSensor => "fingerprint",
            SensorType.FaceRecognition => "face.smiling",
            SensorType.HeartRateSensor => "heart.fill",
